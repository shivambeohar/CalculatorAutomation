...
class CalculatorAutomation extends GebSpec {
    ...
    def "addition_test"() {
        ...
        when: "When perform addition operation: "
        mSimpleCalculatorPage.add("10.1", "12.11")

        then:
        mSimpleCalculatorPage.resultField.getText() == "022.21"
    }
